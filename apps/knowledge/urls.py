...
urlpatterns = [
    ...
    path("library/<int:pk>/<str:slug>/history/", views.RevisionHistoryView.as_view(), name="revision_history"),
    path("library/<int:pk>/<str:slug>/history/<int:revision_number>/", views.RevisionDetailView.as_view(), name="revision_detail"),
    path("library/<int:pk>/<str:slug>/history/<int:revision_number>/compare/", views.RevisionCompareView.as_view(), name="revision_compare"),
    path("library/<int:pk>/<str:slug>/history/<int:revision_number>/restore/", views.RevisionRestoreView.as_view(), name="revision_restore"),
    ...
    path("library/<int:pk>/<str:slug>/verify/", views.MarkVerifiedView.as_view(), name="concept_verify"),
    ...
    path("library/markdown-preview/", views.markdown_preview, name="markdown_preview"),
]
